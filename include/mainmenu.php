                    ...
                    <!-- <ul class="submenu-mainmenu">
                        <li><a href="javascript:void();"><i class="fa fa-circle"></i>Course One<i class="fa fa-angle-right"></i></a>
                            <ul class="sub-submenu-mainmenu">
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses One</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Two</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Three</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Four</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void();"><i class="fa fa-circle"></i>Course Two<i class="fa fa-angle-right"></i></a>
                            <ul class="sub-submenu-mainmenu">
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses One</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Two</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Three</a></li>
                        ...
                        <li><a href="javascript:void();"><i class="fa fa-circle"></i>Course Three<i class="fa fa-angle-right"></i></a>
                            <ul class="sub-submenu-mainmenu">
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses One</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Two</a></li>
                                <li><a href="javascript:void();"><i class="fa fa-circle"></i>Sub Courses Three</a></li>
