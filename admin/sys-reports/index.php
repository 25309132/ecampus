...
$GetTTFine =$common->CCGetDBValue("SELECT sum(libpenaltyamount) as tot FROM libms_penalties_journal ");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <?php include_once('../inc/hmis-management-reports-menu.php'); ?>
    <!-- /.sidebar -->
  </aside>
          ...
          <div class="box box-success">
            <div class="box-body box-profile">
              <center> 
                ...
                <img src="../img/logo.png" alt="" width="auto" height="50"></a>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="SystemQLinksTab">
                <div class="row m_top_20">
                  <?php foreach($sql->GetRows("SELECT * FROM tbl_sys_modules WHERE isDeleted = 0 ORDER BY display_id ASC ") as $M) {?>
                  <div class="col-md-3 m_bottom_20 ">
                      <?php 
                      $gaurl = $sql->GetRows("SELECT * FROM tbl_sys_modules where group_access like  '%".$_SESSION['GrpID']."%'  AND isActive=1 AND url = '{$M["url"]}' AND isDeleted = 0 ");
                      if($gaurl)
