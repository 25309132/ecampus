...
<section class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <?php
		...
		foreach($common->GetRows("SELECT * FROM tbl_sys_module_child WHERE par_id=1 AND group_access LIKE  '%".$_SESSION['GrpID']."%'  AND isActive=1 ORDER BY display_id ASC ;") as $menu)
		{
