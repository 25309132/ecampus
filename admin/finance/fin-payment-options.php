                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Payment Options (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Payment Option </h4></a></li>
                        </ul>
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <input type="text" class="form-control" name="SearchPaymentInfo" id="SearchPaymentInfo" placeholder="Search Payment Option Name / Description" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Payment Option
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Payment Options',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=paymentoptions'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" name="PaymentOptionName" id="PaymentOptionName" placeholder="Payment Option Name" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_Payment_Option" id="Register_Payment_Option" value="1">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="form-group"> 
                                                        <label> Payment Option Description </label>
                                                        <input type="text" class="form-control" id="AddCourseTypeDescription" name="PaymentOptionDescription" placeholder="Payment Option Description" autocomplete="off" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full m_top_20" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;"><span class="glyphicon glyphicon-check"></span> Submit Payment Option </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div><hr/>
                ...
                <div class="modal-dialog" style="width:720px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="t_aling_c"><i class="fa fa-database"></i> Update Payment Option </h4>
                        </div>
...
<script type="text/javascript">
    function LoadUpModal(paymentOptionId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-payment-option.php?paymentOptionId=' + paymentOptionId,
            async: true,
...
<script type="text/javascript">
    jQuery().ready(function () {
        var v = $("#AddStatusesFRM").validate({
            rules: {
                PaymentOptionName: {// PaymentOptionName AddCourseTypeDescription Register_Payment_Option
                    required: true
                }
            },
            errorElement: "span",
