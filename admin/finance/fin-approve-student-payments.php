...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Approve Students Payments
            </h1>
            <ol class="breadcrumb">
                <li><a href="../index"><i class="fa fa-home"></i>Home/ Module Select</a></li>
                <li><a href="javascript:void(0);"> Approve Students Payments </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Approve Students Payments (Search &amp; Approve)</h4></a></li>
                        </ul>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Incoming Payments',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=paymentlist'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                                    ...
                                                    DLButton: {
                                                        ...
                                                        display: function (data) {
                                                            if (data.record.receiptFile) {
                                                                return '<a style="color: white" href="../../img/payment/' + data.record.receiptFile + '" target="_blank"><button class="btn btn-danger w_full"> <span class="glyphicon glyphicon-download"></span> Download </button></a>'
                                                            } else {
                                                                return 'No Receipt'
                                                            }
                                                        }
                                                    ...
                                                    MyButton: {
                                                        ...
                                                        display: function (data) {
                                                          ...
                                                          if(GetIfConfirmed == 1) {
                                                            ...
                                                            return '<?php $CreateButton = ($CanUPDATE == 1) ? '<center><button class="btn btn-info btn-small w_full" onclick="LoadUpModal(\' + data . record . id + \')"><span class="glyphicon glyphicon-check"></span> Approve </button></center>' : ''; echo $CreateButton; ?>';
                                                          }
                                                        }
                                                    },
                                                }
...
<script type="text/javascript">
    ...
    function LoadUpModal(GetSchlID) {
        ...
        $.ajax({
            type: 'post',
            url: '../finance/get-payment-details',
            async: true,
            data: 'GFID='+GetSchlID,
