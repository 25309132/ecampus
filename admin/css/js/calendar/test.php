...
// put here the correct path to "../../Store/js/calendar/calendar.php"; don't move the file
// "../../Store/js/calendar/calendar.php" -- I think it's best if you leave it inside the
