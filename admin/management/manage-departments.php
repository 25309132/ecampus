    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Manage Departments</a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Departments Listing (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Department</h4></a></li>
                        </ul>
                        <div class="tab-content">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <label>Search Department Name / Description </label>
                                                <input type="text" class="form-control" name="SearchDepartmentName" id="SearchDepartmentName" placeholder="Search Department by Name / Description" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Department
                                                </button>
                                            </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Listed Departments',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                selecting: true,
                                                actions: {
                                                    listAction: 'process-listings.php?action=departmentlist'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                            ...
                            <div class="tab-pane" id="AddBookCategory">
                                ...
                                <form class="contact-form cf-style-1 m_bottom_40" name="AddDepartmentFRM"
                                      id="AddDepartmentFRM" method="POST" action="" enctype="multipart/form-data"
                                      action="">
                                    <fieldset>
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" name="AddDepartmentName" id="AddDepartmentName" placeholder="Department Name" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_Department" id="Register_School" value="1">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="form-group"> 
                                                        <label>Department Description</label>
                                                        <input type="text" required class="form-control" id="AddDepartmentDescription" name="AddDepartmentDescription" placeholder="Campus Description" autocomplete="off" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full" name="submit" style="float:center; margin-right: 2.6%; margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Submit Department Details</button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    jQuery().ready(function () {
        var v = jQuery("#AddDepartmentFRM").validate({
            rules: {//AddDepartmentName AddDepartmentDescription
                AddDepartmentName: {
                    required: true
                },
...
<script type="text/javascript">
    ...
    $("form#AddDepartmentFRM").submit(function (e) {
        e.preventDefault();
        if ($('#AddDepartmentFRM').valid()) {
            $("#Loading_ID").show('fast');
            $('#AddDepartmentFRM').hide("fast");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    function close() {
                        ...
                        $('#AddDepartmentFRM').show("fast");
                        $('#AddDepartmentFRM')[0].reset();
