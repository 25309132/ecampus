    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Academic Years </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Academic Years (Search &amp; Edit)</h4></a></li>
                            <li class="pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Academic Years </h4></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label> Academic Year Name / Description </label>
                                                <input type="text" class="form-control" name="SearchAcademicYear" id="SearchAcademicYear" placeholder="Search Academic Years by Name / Description" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Academic Years
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Listed Academic Years',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=academicyears'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                            ...
                                            $('#LoadRecordsButton').click(function (e) {
                                                ...
                                                $('#PeopleTableContainer').jtable('load', {
                                                    SearchAcademicYear: $('#SearchAcademicYear').val()
                                                });
                                            });
                            ...
                            <div class="tab-pane" id="AddBookCategory">
                                ...
                                <form class="contact-form cf-style-1 m_bottom_40" name="AddAcademicYearFRM"
                                      id="AddAcademicYearFRM" method="POST" action="" enctype="multipart/form-data"
                                      action="">
                                    <fieldset>
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="AddAcademicYear" id="AddAcademicYear" placeholder="Academic Year" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_Year" id="Register_Year" value="1">
                                                </div>
                                                <div class="col-md-3">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="radio" style="margin-top:0px;">
                                                      <label for="optionsRadios1">
                                                        <input type="radio" name="GetIsCurrent" id="optionsRadios1" value="1"> Yes &nbsp;&nbsp;&nbsp;
                                                      </label>
                                                      <label for="optionsRadios2">
                                                        <input type="radio" name="GetIsCurrent" id="optionsRadios2" checked value="0"> No
                                                      </label>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full m_top_20" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;"><span class="glyphicon glyphicon-check"></span> Submit Academic Year </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    function LoadUpModal(getYearId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-academicyear.php?getYearId=' + getYearId,
            async: true,
...
<script type="text/javascript">
    jQuery().ready(function () {
        var v = $("#AddAcademicYearFRM").validate({
            rules: {
                AddAcademicYear: {
                    required: true
                },
        ...
        $("form#AddAcademicYearFRM").submit(function (e) {
            e.preventDefault();
            if ($('#AddAcademicYearFRM').valid()) {
                $("#Loading_ID").show('fast');
                $('#AddAcademicYearFRM').hide("fast");
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        function close() {
                            ...
                            $('#AddAcademicYearFRM').show("fast");
                            $('#AddAcademicYearFRM')[0].reset();
