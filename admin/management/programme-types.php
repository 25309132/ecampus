    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Programme Types </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Programme Types (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Programme Type </h4></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label> Programme Type Name / Description </label>
                                                <input type="text" class="form-control" name="SearchProgrammeType" id="SearchProgrammeType" placeholder="Search Academic Years by Name / Description" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Programme Type
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Listed Programme Types',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=programmetypes'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                            ...
                                            $('#LoadRecordsButton').click(function (e) {
                                                ...
                                                $('#PeopleTableContainer').jtable('load', {
                                                    SearchProgrammeType: $('#SearchProgrammeType').val()
                                                });
                                            });
                            ...
                            <div class="tab-pane" id="AddBookCategory">
                                ...
                                <form class="contact-form cf-style-1 m_bottom_40" name="AddProgrammeTypeFRM"
                                      id="AddProgrammeTypeFRM" method="POST" action="" enctype="multipart/form-data"
                                      action="">
                                    <fieldset>
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" name="AddProgrammeType" id="AddProgrammeType" placeholder="Programme Type" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_ProgrammeType" id="Register_ProgrammeType" value="1">
                                                </div>
                                                <div class="col-lg-5">
                                                    <label> Description </label>
                                                    <input type="text" class="form-control" name="AddDescription" id="AddDescription" placeholder="Programme Type Description" autocomplete="off" />
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full m_top_20" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;"><span class="glyphicon glyphicon-check"></span> Submit Programme Type </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog" style="width:720px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="t_aling_c"><i class="fa fa-database"></i> Update Programme Type </h4>
                        </div>
...
<script type="text/javascript">
    function LoadUpModal(getProgrammeId) {
        ...
        $.ajax({
            url: 'ajax-edit-programme-type.php?getProgrammeId=' + getProgrammeId,
            async: true,
...
<script type="text/javascript">
    jQuery().ready(function () {
        var v = $("#AddProgrammeTypeFRM").validate({
            rules: {
                AddProgrammeType: {
                    required: true
                }
        ...
        $("form#AddProgrammeTypeFRM").submit(function (e) {
            e.preventDefault();
            if ($('#AddProgrammeTypeFRM').valid()) {
                $("#Loading_ID").show('fast');
                $('#AddProgrammeTypeFRM').hide("fast");
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        function close() {
                            ...
                            $('#AddProgrammeTypeFRM').show("fast");
                            $('#AddProgrammeTypeFRM')[0].reset();
