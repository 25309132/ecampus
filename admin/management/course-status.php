    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Course Statuses </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Course Statuses (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Course Status </h4></a></li>
                        </ul>
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <label> Course Status Name / Description </label>
                                                <input type="text" class="form-control" name="SearchStatusName" id="SearchStatusName" placeholder="Search Course Status Name / Description" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Course Status
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Listed Course Statuses',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=coursestatus'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" name="AddStatusName" id="AddStatusName" placeholder="Course Status Name" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_StatusName" id="Register_StatusName" value="1">
                                                </div>
                                                <div class="col-lg-5">
                                                    <div class="form-group"> 
                                                        <label> Description </label>
                                                        <input type="text" required class="form-control" id="AddStatusDescription" name="AddStatusDescription" placeholder="Course Status Description" autocomplete="off" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;><span class="glyphicon glyphicon-check"></span> Submit Course Status </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div><hr/>
...
<script type="text/javascript">
    function LoadUpModal(getCourseStatusId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-course-status.php?getCourseStatusId=' + getCourseStatusId,
            async: true,
