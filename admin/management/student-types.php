    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Student Types </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Student Type </h4></a></li>
                        </ul>
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label> Student Type Name / Description </label>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=studenttypes'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="AddStudentType" id="AddStudentType" placeholder="Student Type" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_StudentType" id="Register_StudentType" value="1">
                                                </div>
                                                <div class="col-lg-4">
...
<script type="text/javascript">
    function LoadUpModal(getStudentTypeId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-student-type.php?getStudentTypeId=' + getStudentTypeId,
            async: true,
