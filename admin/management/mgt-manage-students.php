                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#FacilitiesListTab" data-toggle="tab"><h4><i class="fa fa-bars"></i> Students List </h4></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="FacilitiesListTab">
                                ...
                                <div class="d_none member-data-retrieval">
                                    <div class="row">
                                        <div class="col-md-6"><h4><i class="fa fa-check-circle-o"></i> Edit Student Info </h4>
                                        </div>
                                        <div class="col-md-6">
                                            <button class="btn  btn-success btn-md pull-right select-another-member">
                                                <span class="glyphicon glyphicon-check"></span> Select Another Student
                                            </button>
                                        </div>
                                        <div class="col-md-12">
                                            <hr/>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="SearchFNameP" id="SearchFNameP" placeholder="Search Student By Name/ Email/ Phone / Registration Number" autocomplete="OFF">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-users m_top_20 m_bottom_20"></i> Students List',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=GetRegisteredStudentsList'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                                    ...
                                                    status: {
                                                        title: 'Status',
                                                        width: '5%',
                                                        options: 'process-listings.php?action=studentstatuses'
                                                    },
                                                    MyButton: {
                                                        title: 'Action',
                                                        width: '5%',
                                                        display: function (data) {
                                                            return '<?php $CreateButton=($CanUPDATE==1) ? '<center><button class="btn btn-info btn-small w_full" onclick="LoadUpModal(\' + data . record . id + \')"> Manage <span class="glyphicon glyphicon-chevron-right"></span></button></center>' : ''; echo $CreateButton; ?>';
                                                        }
                                                    },
                                                }
                                            });
