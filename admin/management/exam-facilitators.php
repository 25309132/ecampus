...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Manage Exam Facilitators
            </h1>
            <ol class="breadcrumb">
                <li><a href="../index"><i class="fa fa-home"></i>Home/ Module Select</a></li>
                <li><a href="javascript:void(0);"> Manage Exam Facilitators </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Exam Facilitators Listing (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Exam Facilitator </h4></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label> Facilitator Name / Contacts </label>
                                            ...
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Exam Facilitator
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=examfacilitators'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                            ...
                            <div class="tab-pane" id="AddBookCategory">
                                ...
                                <form class="contact-form cf-style-1 m_bottom_40" name="AddSchoolInstitutionFRM" id="AddSchoolInstitutionFRM" method="POST" action="" enctype="multipart/form-data" action="">
                                    <fieldset>
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label> Facilitator Names </label>
                                                    <input type="text" class="form-control" name="AddFacilitatorNames" id="AddFacilitatorNames" placeholder="Facilitator Names" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_Exam_Facilitator" id="Register_Exam_Facilitator" value="1">
                                                </div>
                                                <div class="col-md-4">
                                                    <label> Facilitator Contacts </label>
                                                    <input type="text" required class="form-control" id="FacilitatorContacts" name="FacilitatorContacts" placeholder="Facilitator Contacts" autocomplete="off" />
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full m_top_20" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;"><span class="glyphicon glyphicon-check"></span> Add Facilitator </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog" style="width:720px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="t_aling_c"><i class="fa fa-database"></i> Update Facilitator Details </h4>
                        </div>
...
<script type="text/javascript">
    function LoadUpModal(getFacilitatorId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-facilitators.php?getFacilitatorId=' + getFacilitatorId,
            async: true,
