    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);"> Student Status </a></li>
            </ol>
        </section>
                ...
                <!--Lock User From Accessing This Page -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"><h4><i class="fa fa-list"></i> Student Types (Search &amp; Edit)</h4></a></li>
                            <li class=" pull-right"><a href="#AddBookCategory" data-toggle="tab"><h4><i class="fa fa-plus"></i> Add Student Status </h4></a></li>
                        </ul>
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="filtering m_bottom_20">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <label> Student Status Name / Description </label>
                                                <input type="text" class="form-control" name="SearchStudentStatus" id="SearchStudentStatus" placeholder="Search Student Status" autocomplete="OFF">
                                            </div>
                                            
                                            <div class="col-lg-4">
                                                <button type="submit" id="LoadRecordsButton" class="btn btn-info btn-md w_full m_top_25" style="margin-top: 34px;"><span class="glyphicon glyphicon-check"></span> Search Student Type
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            $('#PeopleTableContainer').jtable({
                                                title: '<i class="fa fa-database m_top_20 m_bottom_20"></i> Listed Student Types',
                                                paging: true,
                                                pageSize: 10,
                                                sorting: true,
                                                ...
                                                actions: {
                                                    listAction: 'process-listings.php?action=studetstatus'
                                                },
                                                fields: {
                                                    id: {
                                                        key: true,
                                            ...
                                            $('#LoadRecordsButton').click(function (e) {
                                                ...
                                                $('#PeopleTableContainer').jtable('load', {
                                                    SearchStudentStatus: $('#SearchStudentStatus').val()
                                                });
                                            });
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control" name="AddStudentStatus" id="AddStudentStatus" placeholder="Student Status" autocomplete="off" />
                                                    <input type="hidden" class="form-control" name="Register_StudentStatus" id="Register_StudentStatus" value="1">
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <?php $CreateButton = ($CanCREATE == 1) ? '<button type="submit" class="btn  btn-info btn-md w_full m_top_20" name="submit" style="float:center; margin-right: 2.6%; margin-top:34px;"><span class="glyphicon glyphicon-check"></span> Submit Student Type </button>' : '';
                                                        echo $CreateButton; ?>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-dialog" style="width:720px;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="t_aling_c"><i class="fa fa-database"></i> Update Student Type </h4>
                        </div>
...
<script type="text/javascript">
    function LoadUpModal(getStudentStatusId) {
        $('#LoadModal').modal({backdrop: 'static', keyboard: false});
        $.ajax({
            url: 'ajax-edit-student-status.php?getStudentStatusId=' + getStudentStatusId,
            async: true,
