...
if (filter_has_var(INPUT_POST, "StudentType")) 
{
  try { 
        ...
        $ProgrammeApplyingFor = $common->CCStrip($_POST['ProgrammeType']);
        ...
        $ConceptPaperName = '';
        $optradio = '';
        $MastersDegreeThesisName = '';
        $MastersDegreeProjectName = '';
        $HowToFinance = '';
        ...
        if($SQLInsert >= 1)
        {
            ...
            $Emessage .= "</body></html>";
            mail($to, "Undergraduate Registration", $Emessage, $headers);
        }
