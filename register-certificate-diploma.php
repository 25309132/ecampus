    ...
    <body>
                    ...
                    <div class="container">
                        <div class="row">        
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-12 form-wizard">
                                <!-- Form Wizard -->
                                <form class="contact-form cf-style-1 m_bottom_40" name="CertificateRegisterFRM" id="CertificateRegisterFRM" method="POST" action="" enctype="multipart/form-data" action="">
                                    <h5> <b> APPLICATION FORM FOR CERTIFICATE COURSE </b></h5>
                                    <!-- Form progress -->
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="hidden" name="StudentType" id="StudentType" value="3">
                                                </div>
                                                <div class="col-md-3">
                                    ...
                                    <fieldset>
                                        ...
                                        <h6> 2. CERTIFICATE COURSE APPLIED FOR: </h6>
                                        
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label> Choose Certificate/Diploma Course: <span>*</span></label><br/>
                                                    <select class="form-control select2" name="ProgrammeType" id="ProgrammeType" style="width: 100%; border-radius: 0; height:36px;">
                                                        <option value=""> Choose Certificate/Diploma Course </option>
                                                        <?php
                                                        foreach ($common->GetRows("SELECT * FROM tbl_programmes WHERE type_id = 3 AND isActive = 1") as $A) {
                                                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row DynamicFormTab pt-20">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" id="Qualifications-1" class="form-control required" name="Qualifications[]" placeholder="Qualifications" autocomplete="OFF">
                                                    <input type="hidden" id="ProfessionalQualification-1" name="ProfessionalQualification[]" required>
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="WhereObtained"> Where obtained <span>*</span></label>
                                                    <input type="text" id="WhereObtained-1" class="form-control required" name="WhereObtained[]" placeholder="Where Obtained" autocomplete="OFF">
                                                </div> 
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="input-group bootstrap-timepicker">
                                                      ...
                                                      <input type="text" class="form-control datepicker required" id="QualificationsStartDate-1" name="QualificationsStartDate[]" placeholder="Start Date" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="input-group bootstrap-timepicker">
                                                      ...
                                                      <input type="text" class="form-control datepicker required" id="QualificationsEndDate-1" name="QualificationsEndDate[]" placeholder="End Date" autocomplete="off">
                                                    </div>
                                                </div>                                                       
                                                <div class="col-md-2">
                                                    <label for="AwardObtained"> Award Obtained <span>*</span></label>
                                                    <input type="text" id="AwardObtained-1" class="form-control required"  name="AwardObtained[]" placeholder="Award Obtained" autocomplete="OFF">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row DynamicFormTab pt-20">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" id="Position-1" class="form-control required" name="Position[]" placeholder="Position" autocomplete="OFF">
                                                    <input type="hidden" id="DynamicFieldPosition-1" name="DynamicFieldPosition[]" required>
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="EmploymentPlace"> Place <span>*</span></label>
                                                    <input type="text" id="EmploymentPlace-1" class="form-control required" name="EmploymentPlace[]" placeholder="Employment Place" autocomplete="OFF">
                                                </div>
                                                <div class="col-md-2">
                                                    <label>Start Date: <span>*</span></label><br/>
                                                    <div class="input-group bootstrap-timepicker">
                                                      ...
                                                      <input type="text" class="form-control datepicker required" id="EmploymentStartDate-1" name="EmploymentStartDate[]" placeholder="Start Date" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="input-group bootstrap-timepicker">
                                                      ...
                                                      <input type="text" class="form-control datepicker required" id="EmploymentEndDate-1" name="EmploymentEndDate[]" placeholder="End Date" autocomplete="off">
                                                    </div>
                                                </div>                                                       
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="Referee1Title" id="Referee1Title" placeholder="Referee1 Title" class="form-control required">
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label>  Name </label><br/>
                                                    <input type="text" name="Referee2Name" id="Referee2Name" placeholder="Referee2 Name" class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label>  Title </label><br/>
                                                    <input type="text" name="Referee2Title" id="Referee2Title" placeholder="Referee2 Title" class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label>  Address </label><br/>
                                                    <input type="text" name="Referee2Address" id="Referee2Address" placeholder="Referee2 Address" class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label>  Email Address </label><br/>
                                                    <input type="email" name="Referee2Email" id="Referee2Email" placeholder="Referee2 Email" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label>  Telephone </label><br/>
                                                    <input type="text" name="Referee2Telephone" id="Referee2Telephone" placeholder="Referee2 Telephone" class="form-control">
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="form-wizard-buttons">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                toastr.info('Welcome to certificate/diploma registration. Please fill all the required fields marked with asterik (*) to proceed');
                ...
                $("form#CertificateRegisterFRM").submit(function (e) {
                    ...
                    if ($('#CertificateRegisterFRM').valid()) {
                        ...
                        $.ajax({
                            url: 'submit-certificate-diploma',
                            type: 'POST',
                            data: formData,
                            async: true,
            ...
            var fieldscount = 1;
            $("#addButton").click(function (e) { //Qualifications WhereObtained DateFromTo AwardObtained
                e.preventDefault();
                fieldscount++;
                $("#dynamic_fields").append('<div class="row pt-20">' +
                    '<div  class="col-md-2">' +
                    '<div class="m_top_15 m_xs_bottom_15">' +
                    '<input type="text" id="Qualifications-' + fieldscount + '" required class="form-control item-name" name="Qualifications[]" placeholder="Qualifications" autocomplete="OFF">' +
                    '<input type="hidden" id="ProfessionalQualification-' + fieldscount + '" name="ProfessionalQualification[]" required>' +
                    '</div>' +
                    '</div>' +
                    '<div  class="col-md-2">' +
                    '<input type="text" id="WhereObtained-' + fieldscount + '" required="required" class="form-control t_align_c"  name="WhereObtained[]" placeholder = "Where Obtained"  autocomplete="OFF">' +
                    '</div>' +    
                    '<div  class="col-md-2">' +
                    '<input type="text" id="QualificationsStartDate-' + fieldscount + '" required="required" class="form-control datepicker"  name="QualificationsStartDate[]" placeholder = "Start Date" autocomplete="OFF">' +
                    '</div>' +
                    '<div  class="col-md-2">' +
                    '<input type="text" id="QualificationsEndDate-' + fieldscount + '" required="required" class="form-control datepicker"  name="QualificationsEndDate[]" placeholder = "End Date" autocomplete="OFF">' +
                    '</div>' +
                    '<div class="col-md-2">' +
            ...
            $("#addSubjectButton").click(function (e) { 
                ...
                $("#dynamic_fields_subjects").append('<div class="row pt-20">' +
                    '<div  class="col-md-4">' +
                    '<div class="m_top_15 m_xs_bottom_15">' +
                    '<input type="text" id="Subject-' + fieldscount2 + '" required class="form-control item-name" name="Subject[]" placeholder="Indicate Subject" autocomplete="OFF">' +
                    '<input type="hidden" id="DynamicSubjects-' + fieldscount2 + '" name="DynamicSubjects[]">' +
                    '</div>' +
                    '</div>' +
                    '<div  class="col-md-4">' +
                    '<input type="text" id="GradeObtained-' + fieldscount2 + '" required="required" class="form-control t_align_c"  name="GradeObtained[]" placeholder = "e.g. A, B, C"  autocomplete="OFF">' +
                    '</div>' +              
                    '<div class="col-md-4">' +
            ...
            $("#addKACSubjectButton").click(function (e) { 
                ...
                $("#dynamic_fields_kacsubjects").append('<div class="row pt-20">' +
                    '<div  class="col-md-4">' +
                    '<div class="m_top_15 m_xs_bottom_15">' +
                    '<input type="text" id="KACSubject-' + fieldscount3 + '" required class="form-control item-name" name="KACSubject[]" placeholder="Indicate Subject" autocomplete="OFF">' +
                    '<input type="hidden" id="KACDynamicSubjects-' + fieldscount3 + '" name="KACDynamicSubjects[]">' +
                    '</div>' +
                    '</div>' +
                    '<div  class="col-md-4">' +
                    '<input type="text" id="KACGradeObtained-' + fieldscount3 + '" required="required" class="form-control t_align_c"  name="KACGradeObtained[]" placeholder = "Grade Obtained"  autocomplete="OFF">' +
                    '</div>' +              
                    '<div class="col-md-4">' +
            ...
            $("#addEmploymentButton").click(function (e) { 
                ...
                $("#dynamic_fields_employment").append('<div class="row pt-20">' +
                    '<div class="col-md-3">' +
                    '<div class="m_top_15 m_xs_bottom_15">' +
                    '<input type="text" id="Position-' + fieldscount4 + '" required class="form-control item-name" name="Position[]" placeholder="Position" autocomplete="OFF">' +
                    '<input type="hidden" id="DynamicFieldPosition-' + fieldscount4 + '" name="DynamicFieldPosition[]">' +
                    '</div>' +
                    '</div>' +
                    '<div  class="col-md-3">' +
                    '<input type="text" id="EmploymentPlace-' + fieldscount4 + '" required="required" class="form-control t_align_c"  name="EmploymentPlace[]" placeholder = "Employment Place"  autocomplete="OFF">' +
                    '</div>' +  
                    '<div  class="col-md-2">' +
                    '<input type="text" id="EmploymentStartDate-' + fieldscount4 + '" required="required" class="form-control t_align_c"  name="EmploymentStartDate[]" placeholder = "Start Date"  autocomplete="OFF">' +
                    '</div>' +   
                    '<div  class="col-md-2">' +
                    '<input type="text" id="EmploymentEndDate-' + fieldscount4 + '" required="required" class="form-control t_align_c"  name="EmploymentEndDate[]" placeholder = "End Date"  autocomplete="OFF">' +
                    '</div>' +
